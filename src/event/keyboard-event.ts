...
export class KeyboardEventHandler extends BaseEventHandler {
  ...
  compositionEndHandler(e: CompositionEvent) {
    ...
    const text = e.data;
    if (text) {
      console.log("compositionEndHandler: text:", text);
  ...
  beforeInputHandler_(e: InputEvent) {
    ...
    switch (inputType) {
      ...
      case 'insertText':
        text = e.data;
        if (text) {
          console.log("beforeInputHandler - insertText - text:", text);
          this.editor.insertTextAtCursor(text);
        }
        break;
      case 'insertFromPaste':
        ...
        if (text) {
          console.log("beforeInputHandler - insertFromPaste - text:", text);
          this.editor.insertTextAtCursor(text);
        }
        break;
    }
